$(document).ready(function () {
    ...
    }); if (parseInt($.totalStorage('live_configurator_visibility')) == 1) { $('#tool_customization').animate({ left: '0px' }, 200); $('#gear-right').animate({ left: '280px' }, 200); } else { $('#tool_customization').animate({ left: '-280px' }, 200); $('#gear-right').animate({ left: '0px' }, 200); }
}); function closePopup() { $('#newsletter_popup, .newsletter-overlay').fadeOut(300, function () { $('#newsletter_popup').remove() }); $('button#module-tmnewsletter').removeClass('disable'); }
