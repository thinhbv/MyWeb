...
namespace MyWeb.Data
{
    ...
    public class SqlDataProvider
    {
		...
		static string strConStr = @"Data Source=THINHBV-PC\MSSQLSERVER_2008;Initial Catalog=DaMyNghe;User ID=sa;Password=Thinh!@#123;Pooling=true;Max Pool Size=256;Min Pool Size=16;";
#else
